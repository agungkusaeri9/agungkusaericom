...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Kategori Proyek</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="{{ route('admin.dashboard') }}">Dashboard</a></div>
                <div class="breadcrumb-item">Kategori Proyek</div>
            </div>
        </div>
    ...
    <script>
        $(function() {
            ...
            let otable = $('#dTable').DataTable({
                ...
                serverSide: true,
                responsive:true,
                ajax: '{{ route('admin.project-categories.data') }}',
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
            ...
            $('#myModal #myForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: '{{ route('admin.project-categories.store') }}',
                    type: 'POST',
                    dataType: 'JSON',
                    data: form.serialize(),
            ...
            $('body').on('click', '.btnDelete', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ url("admin/project-categories/") }}' + '/' + id,
                            type: 'DELETE',
                            dataType: 'JSON',
                            success: function(response) {
                               swal(response);
