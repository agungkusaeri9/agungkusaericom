                            ...
                            <form action="{{ route('admin.projects.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="project_category_id" id="project_category_id"
                                                ...
                                                @foreach ($categories as $category)
                                                    <option @selected($category->id == old('project_category_id')) value="{{ $category->id }}">{{ $category->name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            <label for="project_tag_id">Tag <span>(Dapat memilih lebih dari 1 tag)</span></label>
                                            <select name="project_tag_id[]" id="project_tag_id"
                                                class="form-control select2 @error('project_tag_id') is-invalid @enderror" multiple>
                                                @foreach ($tags as $tag)
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="status" id="status" class="form-control @error('status') is-invalid @enderror">
                                                ...
                                                <option @selected(old('status') === 'ON PROGRESS') value="ON PROGRESS">ON PROGRESS</option>
