                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="post_tag_id">Tag <span>(Dapat memilih lebih dari 1
                                                    tag)</span></label>
                                            <select name="post_tag_id[]" id="post_tag_id"
                                                class="form-control select2 @error('post_tag_id') is-invalid @enderror"
                                                multiple>
                                                @foreach ($post_tags as $tag)
                                                    <option @if (old('post_tag_id') == $tag->id) selected @endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="short_description" id="short_description"
                                                ...
                                                style="min-height: 120px">{{ old('short_description') }}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="meta_description" id="meta_description"
                                                ...
                                                style="min-height: 120px">{{ old('meta_description') }}</textarea>
