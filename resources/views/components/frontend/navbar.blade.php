            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <ul class="nav navbar-nav menu_nav justify-content-end">
                        ...
                        <li class="nav-item @if(Route::currentRouteName() === 'projects.index' || Route::currentRouteName() === 'projects.show') active @endif"><a class="nav-link" href="{{ route('projects.index') }}">Projects</a></li>
