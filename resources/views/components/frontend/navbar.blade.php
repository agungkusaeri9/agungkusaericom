{{-- <div class="navbar bg-black-300 px-32 border border-gray-100 shadow-sm">
    <div class="flex-1">
        <a class="btn btn-ghost text-xl">Agung Kusaeri</a>
    </div>
    <div class="flex-none">
...
<nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Agung Kusaeri</span>
        </a>
