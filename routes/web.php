...
Route::get('services/jasa-pembuatan-web', function () {
    $setting = Setting::first();
    $message = 'Halo, saya tertarik dengan jasa pembuatan website yang Anda tawarkan. Bisa minta informasi lebih lanjut?';
    $link = 'https://wa.me/' . $setting->whatsapp_number . '?text=' . urlencode($message);
